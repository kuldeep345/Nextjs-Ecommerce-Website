...
const signup = () => {
  return (
    ...
    <div className="flex flex-col md:px-6 py-8 mr-4 mx-auto lg:py-0">
        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
              Already have an account? <Link href="/login" className="font-medium text-white/50 hover:underline cursor-pointer">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
